    ...
    <div class="relative p-4 bg-white rounded-lg shadow-lg w-full max-w-md mx-auto">
        ...
        <div class="text-center">
            <div class="flex justify-center items-center mb-4">
                <svg class="text-yellow-400 w-12 h-12" aria-hidden="true" xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 20 20">
                    <path stroke="currentColor" stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M10 11V6m0 8h.01M19 10a9 9 0 1 1-18 0 9 9 0 0 1 18 0Z"/>
                </svg>
            </div>
            <h3 class="mb-5 text-lg font-normal text-gray-800">¿Estás seguro de que deseas eliminar este permiso?</h3>
            <div class="flex justify-center gap-4">
                ...
                <button data-modal-hide="popup-modal" id="btnCancelarEliminar" type="button" class="text-gray-500 bg-white hover:bg-gray-100 focus:ring-4 focus:outline-none focus:ring-gray-200 rounded-lg border border-gray-200 text-sm font-medium px-5 py-2.5 hover:text-gray-900">
                    No, cancelar
                </button>
            </div>
        </div>
            ...
            <form action="../../Backend/tablas/actions/actualizar-usuario.php" method="post" id="formulario">
              ...
              <div class="grid gap-4 mb-4 ">
                <div>
                  ...
                  <input type="text" name="nombre" id="editar-nombre" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Ingresar nombre" required>
                </div>

                <div>
                  <label for="apellido" class="block mb-2 text-sm font-medium text-gray-700">Apellido </label>
                  <input type="text" name="apellido" id="editar-apellido" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Ingresar Apellido" required>
                </div>


                <div>
                  <label for="usuario" class="block mb-2 text-sm font-medium text-gray-700">Usuario </label>
                  <input type="text" name="usuario" id="editar-usuario" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Ingresar usuario" required>
                </div>
                ...
                <div>
                  <label for="contraseña" class="block mb-2 text-sm font-medium text-gray-700">Nueva Contraseña
                  </label>
                  <input type="password" name="nueva_contraseña" id="editar-nueva_contraseña" class="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-primary-600 focus:border-primary-600 block w-full p-2.5" placeholder="Nueva contraseña">

                </div>

                <div>

                  <label for="contraseña" class="block mb-2 text-sm font-medium text-gray-700">Tipo de Usuario
                  </label>
              ...
              <button type="submit" class="text-white bg-blue-700 hover:bg-blue-800 focus:ring-4 focus:ring-blue-300 font-medium rounded-lg text-sm px-5 py-2.5 me-2 mb-2">Añadir Solicitud</button>
...
<div id="confirmar-editar" tabindex="-1" class="hidden overflow-y-auto overflow-x-hidden fixed inset-0 z-50 flex justify-center items-center w-full h-full bg-black bg-opacity-50">
    <div class="relative p-4 bg-white rounded-lg shadow-lg w-full max-w-md mx-auto">
        ...
        <div class="text-center">
            ...
            <h3 class="mb-5 text-lg font-normal text-gray-800">¡El Usuario ha sido actualizado exitosamente!</h3>
            <div class="flex justify-center gap-4">
