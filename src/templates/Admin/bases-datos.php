...
<section class="p-4 sm:ml-64 mt-10" id="section">
  ...
  <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 mb-4"> 
    ...
    <div class="flex flex-col items-center justify-center p-4 rounded-lg bg-gray-100 text-gray-700 font-medium shadow-md w-full col-span-1 sm:col-span-2 lg:col-span-1">
