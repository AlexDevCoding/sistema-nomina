...
<html lang="es">
  ...
  <body class=" ">
    ...
    <form
      class="w-[90%] max-w-[400px] absolute top-[50%] left-[50%] translate-x-[-50%] translate-y-[-50%] rounded-[20px] bg-white " action="../Backend/login.php" id="loginForm"
    method="POST">
      ...
      <div class="flex flex-col items-center overflow-hidden">
        ...
        <div class="relative z-0 w-full mb-5 group">
            <input
              ...
              class="block py-2.5 px-0 w-full text-sm text-[#000000] bg-transparent border-0 border-b-2 border-gray-300 autofill:bg-yellow-200 appearance-none  dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer"
              placeholder=" "
              required
            />
            <label
